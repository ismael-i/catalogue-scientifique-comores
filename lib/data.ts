...
export const MOCK_CHERCHEURS: Chercheur[] = [
  {
    ...
    photoUrl: '/chercheurs/DR NADJIM.webp',
    fiche:'chercheurs/fiche/DR NADJIM.pdf',
    institutionId: 'udc',
    institution: 'UDC',
    faculty: 'FST',
    laboratoireId: 'lsml',
  ...
  },
  {
    ...
    photoUrl: '/chercheurs/Dr Andiliyat Said Mohamed.webp',
     fiche: 'chercheurs/fiche/Dr Andiliyat Said Mohamed.pdf',
    institutionId: 'udc',
    institution: 'UDC',
    faculty: 'FST',
    laboratoireId: 'hnc',
  ...
  },
  {
    ...
    photoUrl: '/chercheurs/Dr Said Hassani Mohamed.webp',
     fiche: 'chercheurs/fiche/Dr Said Hassani Mohamed.pdf',
    institutionId: 'udc',
    institution: 'UDC',
    faculty: 'FST',
  ...
  },
  {
    ...
    photoUrl: '/chercheurs/Dr Malik El-Houyoun Ahamada.webp',
    fiche: 'chercheurs/fiche/Dr Malik El-Houyoun Ahamada.pdf',
    institutionId: 'udc',
    institution: 'UDC',
    faculty: 'FST',
    laboratoireId: 'lema',
  ...
  {
    id: 'abdoulanfour-abdou',
    name: 'Dr Abdoulanfour Abdou',
    photoUrl: '/chercheurs/Abdoulanfour Abdou_Chef de département du BGC_Directeur projet Géothermie.webp',
    fiche :'chercheurs/fiche/Dr Abdoulanfour Abdou.pdf',
    institutionId: 'bgc',
    institution: 'BGC',
    laboratoireId: 'bgc',
    laboratoire: "Bureau Géologique des Comores",
    effectif: 54,
    specialty: "Géophysique,géologie, géochimie",
    publications:
      'études géothermie,eaux',
    partenariats: 'ANAP, DGRH,CNDRS, AIDE ',
    phone: '3227652',
  },
  {
    id: 'halassi-abdoulhafar',
    name: 'Dr Halassi Abdoulhafar',
    photoUrl : '/chercheurs/Dr Halassi Abdoulhafar.webp',
    fiche : 'chercheurs/fiche/Dr Halassi Abdoulhafar.pdf',
    institutionId: 'udc',
    institution: 'UDC',
    faculty: 'FST',
    laboratoireId: 'lmsia',
  ...
  {
    id: 'mohamed-mboreha',
    name: 'Dr Mohamed Mboreha Selemane',
    photoUrl: '/chercheurs/MOHAMED-MBOREHA-SELEMANE-CNDRS.webp',
    fiche: 'chercheurs/fiche/MOHAMED-MBOREHA-SELEMANE-CNDRS.pdf',
    institutionId: 'cndrs',
    institution: 'CNDRS',
     laboratoireId: 'ura',
    laboratoire: 'Unité de Recherche en Anthropologie',
    specialty: 'Societe Comorienne',
  },
  {
    id: 'soidrou-said-hassane',
    name: 'Dr Soidrou Said Hassane ',
    photoUrl: '/chercheurs/Dr Soidrou Said Hassane.webp',
    fiche: 'chercheurs/fiche/Dr Soidrou Said Hassane.pdf',
    institutionId: 'udc',
    institution: 'UDC',
    faculty: 'FST',
     laboratoireId: 'lar2sn',
    laboratoire: 'Laboratoire Aliments, Réactivité et Synthèse des Substances Naturelles',
      effectif: 10,
    specialty: '',
  },
  {
    id: 'irchad-ahmed',
    name: 'Dr. Irchad Ahmed',
    fiche: 'chercheurs/fiche/Dr. Irchad Ahmed.pdf',
    institutionId: 'inrape',
    institution: 'INRAPE',
    laboratoireId: 'lcqrv',
    laboratoire: 'Laboratoire Contrôle Qualité, Recherche et Vulgarisation',
    effectif : 12,
    partenariats: 'UdC, CNDRS, BGC',
   
    specialty: 'Biodiversité des Plantes et Ingénierie Agroalimentaire',
  },
  {
    id: 'abeid-said-nassor',
    name: 'Dr Abeid Said Nassor',
    photoUrl : '/chercheurs/Dr Abeid Said Nassor_Leens.webp',
    fiche: 'chercheurs/fiche/Dr Abeid Said Nassor_Leens.pdf',
    institutionId: 'udc',
    institution: 'UDC',
    faculty: 'FST',
      laboratoireId: 'leens',
    laboratoire: 'Laboratoire Entomologie Neurosciences et Santé',
    specialty: '',
  },
  {
    id: 'hamidou-soule',
    name: 'Dr Hamidou Soulé',
    fiche: 'chercheurs/fiche/Dr-Hamidou-Soule.pdf',
    institutionId: 'cndrs',
    institution: 'CNDRS',
    laboratoireId: 'lrcn',
    laboratoire: 'Laboratoire Risques et Catastrophes Naturelles',
    specialty: 'Volcanologie',
    phone: '2693321208',
  partenariats: 'Piton de la Fournaise',
  },
  {
    id: 'anli-mohamed',
    name: 'Dr Anli Mohamed',
    fiche: 'chercheurs/fiche/Dr-Anli-Mohamed.pdf',
    institutionId: 'udc',
    institution: 'UDC',
    faculty: 'PATSY',
    laboratoireId: 'gavd',
    laboratoire: 'Gestion agricole et valorisation des déchets',
    specialty: 'Valorisation et transfirmations des déchets',
  },
   {
    id: 'abdoussalami-mohamed',
    name: 'Dr Abdoussalami Mohamed',
    fiche: 'chercheurs/fiche/Dr-Abdoussalami-Mohamed.pdf',
    institutionId: 'udc',
    institution: 'UDC',
    faculty: 'MVOUNI',
    laboratoireId: 'larjes',
    laboratoire: 'Laboratoire de Recherche Juridique Économiques et Sociales (LARJES)',
    specialty: '',
  },
  {
    id: 'azali-ahamada-inrape',
    name: 'Dr Azali Ahamada',
    fiche: 'chercheurs/fiche/lntpb.pdf',
    institutionId: 'lntpb-epic',
    institution: 'LNTPB-EPIC',
    laboratoireId: 'lntpb',
    laboratoire: 'Laboratoire National de Travaux Publics et Bâtiment (LNTPB)',
